...
**/
var PROFILE_REQUEST_URL = 'https://api.github.com/users/ambershen';
    ...
    return (
      ...
      <Container>
        ...
        <View style={styles.profileButtons}>
          <Button transparent black onPress={() => this.props.navigation.navigate("Repo")}>
            <Text>{this.state.repositories+ "\nRepositories"}</Text>
          </Button>
          <Button transparent black onPress={() => this.props.navigation.navigate("Followers")}>
            <Text>{this.state.followers + "\nFollowers"}</Text>
          </Button>
          <Button transparent black onPress={() => this.props.navigation.navigate("Following")}>
